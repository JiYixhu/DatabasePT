...
<center>
    <h1>类别添加</h1>
    <form action="${pageContext.request.contextPath}/AdminServlet?flag=addCa" method="post">
        <table width="60%">
            <tr>
                <td bgcolor="#AFEEEE" width="30%" >类别代码</td>
                <td width="70%" >
                    <input style="width: 415px;height: 30px;" type="text" name="HaCateNo">
                </td>
            </tr>
            <tr>
                <td bgcolor="#AFEEEE" width="30%" >类别名称</td>
                <td width="70%" >
                    <input style="width: 415px;height: 30px;" type="text" name="HaCate">
                </td>
            </tr>
        </table>
        <br>
