...
<center>
    <br><h1>实时报价列表</h1><br>
    <c:set var="url" value="${pageContext.request.contextPath}/UserServlet?flag=Pricelist" />
    ...
    <table class="table" width="80%">
        ...
        <c:forEach var="price" items="${pageBean.data}">
            <tr>
                <td><a href="${pageContext.request.contextPath}/UserServlet?flag=showHadetail&id=${price.HaNo}">${price.HaNo}</a></td>
                <td>${price.HaName}</td>
