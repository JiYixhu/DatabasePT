...
<center>
    ...
    <table width="90%">
        ...
        <tr>
            <td colspan="5">
                <a href="${pageContext.request.contextPath}/UserServlet?flag=weeklist&id=${hardware.HaNo}">查看近一周报价信息</a>
                <a href="${pageContext.request.contextPath}/UserServlet?flag=Halist">返回</a>
            </td>
        </tr>
    </table>
</center>