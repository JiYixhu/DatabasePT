...
<body>
<center>
    <h2>品牌信息修改</h2><!--类别代码不可修改-->
    <form action="${pageContext.request.contextPath}/AdminServlet?flag=updateBr" method="post">
        <table width="60%">
            <tr>
                <td bgcolor="#AFEEEE" width="30%" >品牌代码</td>
                <td width="70%" style="width: 415px;height: 30px;">
                   <%=request.getParameter("HaBrandNo")%>
                </td>
            </tr>
            <tr>
                <td bgcolor="#AFEEEE" width="30%" >品牌名称</td>
                <td width="70%" >
                    <input style="width: 415px;height: 30px;" type="text" name="HaBrand" placeholder="<%=request.getParameter("HaBrand")%>">
                </td>
            </tr>
        </table>
        <br>
