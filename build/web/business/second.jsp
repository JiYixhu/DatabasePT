...
<center>
    ...
    <form action="${url}" method="post" style="margin-bottom: 10px;"> 
        <input placeholder="输入硬件名称关键字" style="width: 200px;height: 30px;" type="text" name="Name1">&nbsp或&nbsp
        <input  placeholder="输入商家名称关键字" style="width: 200px;height: 30px;" type="text" name="Name2">
